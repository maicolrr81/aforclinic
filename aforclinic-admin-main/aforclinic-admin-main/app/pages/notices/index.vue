...
// 서버 데이터 불러오기
const { data, refresh } = await useAsyncData<ApiPagedResponse<NoticePost>>(async () => {
  const data = await $api<ApiPagedResponse<NoticePost>>(`/notices`, {
    params: params.value,
  });
